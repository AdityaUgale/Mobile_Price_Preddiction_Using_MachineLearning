...
st.markdown("Find about your mobile price range or just see based on your inputs, which range it will fall to! Click the button below and input the required specifications for the mobile phone!!")
